...
def new_run():
    ...
    Label(f17,text = "ONLINE BUS BOOKING SYSTEM", font=("Arial",27), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
    Label(f17,text = "Add New Running Details", font=("Arial",27), fg = 'light green').grid(row=2,column=0,columnspan=5,pady=20)

    f18=Frame(f17)
    f18.grid(row = 3, column = 0, columnspan = 15,pady = 20)
    Label(f18,text = "Bus Id ", font=("Arial",15),fg='dark green').grid(row=0,column=0,padx = 20)
    e23 = Entry(f18)
    e23.grid(row=0,column=1)
    Label(f18,text = "Running Date (DD-MM-YY)", font=("Arial",17),fg='dark green').grid(row=0,column=2,padx=20)
    e24 = Entry(f18)
    e24.grid(row=0,column=3)
    Label(f18,text = "Seat Available", font=("Arial",15),fg='dark green').grid(row=0,column=4,padx = 10+10)
    e25 = Entry(f18)
    ...
    def add_run():
        ...
        if len(already):
            showerror("Error","Route details exist")
        else:
            ...
            row=row[0]
            con.commit()
            showinfo("Successful", row)

    def delete_run():
        cur.execute('DELETE FROM runs WHERE bus_id='+e23.get()+' AND journey_date="'+e24.get()+'"')
        con.commit()

        showinfo("Deleted","running details deleted successfully!!")
        
    button20 = Button(f18,text = "Add Run",font=("Arial",15),bg='red',command=add_run).grid(row=0,column=6,padx=20,pady=20)
    button21 = Button(f18,text = "Delete",font=("Arial",15),fg='red',bg='yellow',command=delete_run).grid(row=0,column=7,padx=20,pady=20)
...
def new_route():
    ...
    Label(f16,text = "Route Id ", font=("Arial",17),fg='light green').grid(row=0,column=0,padx = 20)
    e20 = Entry(f16)
    e20.grid(row=0,column=1)
    Label(f16,text = "Station Name ", font=("Arial",17),fg='light green').grid(row=0,column=2,padx = 20)
    e21 = Entry(f16)
    e21.grid(row=0,column=3)
    Label(f16,text = "Station ID ", font=("Arial",17),fg='light green').grid(row=0,column=4,padx = 10+10)
    e22 = Entry(f16)
...
def new_bus():
    ...
    Label(f14,text = "Bus Id ", font=("Arial",18),fg='light green').grid(row=0,column=0,padx = 20)
    e14 = Entry(f14)
    e14.grid(row=0,column=1)
    Label(f14,text = "Bus Type ", font=("Arial",18),fg='light green').grid(row=0,column=2,padx=20)
    menu1= StringVar()
    menu1.set("CHOOSE")
    drop2 = OptionMenu(f14, menu1,"AC 2x2","AC 3x2","Non-AC 2x2","Non-AC 3x2","AC Sleeper 2x2","Non-AC Sleeper 2x2").grid(row=0,column=3)
    Label(f14,text = "Capacity ", font=("Arial",18),fg='black').grid(row=0,column=4,padx= 20)
    e16 = Entry(f14)
    e16.grid(row=0,column=5)
    Label(f14,text = "Fare Rs ", font=("Arial",18),fg='black').grid(row=0,column=6,padx = 15)
    e17 = Entry(f14)
    e17.grid(row=0,column=7)
    Label(f14,text = "Operator ID", font=("Arial",18),fg='black').grid(row=0,column=8, padx = 19)
    e18 = Entry(f14)
    e18.grid(row=0,column=9)
    Label(f14,text = "Route ID", font=("Arial",18),fg='black').grid(row=0,column=10, padx = 19)
    e19 = Entry(f14)
    ...
    button17 = Button(f14,text = "Add Bus",font=("Arial",15),bg='light green',anchor=CENTER,command=add_bus).grid(row=1,column=0,padx=20,pady=20,columnspan=25)
    button18 = Button(f14,text = "Delete",font=("Arial",15),bg='light green',anchor=CENTER,command=delete_bus).grid(row=1,column=2,padx=20,pady=20,columnspan=15)
...
def new_operator():
    ...
    Label(f11,text = "ONLINE BUS BOOKING SYSTEM", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
    ...
    button16 = Button(f12,text = "Delete",font=("Arial",15),bg='light green',command=delete_op).grid(row=0,column=11,padx=20)
...
def ticketShow(row):
    ...
    Label(f4,text = "ONLINE BUS BOOKING SYSTEM", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def seat_book():
    ...
    def proceed_to(f5,busch,fare):
        if type(busch)!=int:
            ...
            def booked(fare):
                ...
                for i in insertRow:
                    if i=="":
                        showinfo("Invalid Data","Please enter all the details!")
                        break
    ...
    def show_bus(f5):
        if e1.get()=="" and e2.get()=="" and e3.get()=="":
            ...
            Label(f6,text = "Select BUS ", font=("Arial",15),fg='black').grid(row=0,column=0,padx = 20)
            Label(f6,text = "Operator ", font=("Arial",15),fg='black').grid(row=0,column=1,padx=20)
            Label(f6,text = "Bus Type ", font=("Arial",15),fg='black').grid(row=0,column=2,padx= 20)
            Label(f6,text = "Availability ", font=("Arial",15),fg='black').grid(row=0,column=3,padx = 10+10)
            Label(f6,text = "Fare ", font=("Arial",15),fg='black').grid(row=0,column=4, padx = 19+1)
            i,busch=1,IntVar()
            for row in data:
...
def check_booked_seat(f2):
    ...
    Label(f7,text = "ONLINE BUS BOOKING SYSTEM", font=("Arial",25), bg = 'deep sky blue', fg = 'red',anchor=CENTER ).grid(row=1,column=0,columnspan=5)
...
def add_bus():
    ...
    Label(f9,text = "ONLINE BUS BOOKING SYSTEM", font=("Arial",25), bg = 'deep sky blue', fg = 'red',anchor=CENTER ).grid(row=1,column=0,columnspan=5)
...
def tab2():
    ...
    Label(f2,text = "ONLINE BUS BOOKING SYSTEM", font=("Arial",25), bg = 'deep sky blue', fg = 'red',anchor=CENTER ).grid(row=1,column=0,columnspan=5)
    f3 =Frame(f2,pady=20)
...
def tab1():
    ...
    Label(f1,text = "ONLINE BUS BOOKING SYSTEM", font=("Arial",25), bg = 'deep sky blue', fg = 'red' ).pack()
    Label(f1,text = "Name : Piyush Prabhakar", font=("Arial",15),fg='blue',anchor = S,pady=50).pack()
    Label(f1,text = "Enrollment No. : 211B207", font=("Arial",14),fg='blue',anchor = S).pack()
    Label(f1,text = "Mobile : **********", font=("Arial",14),fg='blue',anchor = S, pady=50).pack()
